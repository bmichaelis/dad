...
(function($, undefined) {
  ...
  $.lithium = lithium = {
    ...
    handleRemote: function(element) {
      ...
      if (lithium.fire(element, 'ajax:before')) {
        ...
        } else if (element.is(lithium.inputChangeSelector)) {
  ...
  $(document).delegate(lithium.formSubmitSelector, 'submit.lithium', function(e) {
    var form = $(this),
    ...
    if (blankRequiredInputs && form.attr("novalidate") == undefined && lithium.fire(form, 'ajax:aborted:required', [blankRequiredInputs])) {
      return lithium.stopEverything(e);
    }
    ...
    if (remote) {
      ...
      if (!$.support.submitBubbles && $().jquery < '1.7' && lithium.callFormSubmitBindings(form, e) === false) return lithium.stopEverything(e);
  ...
  $(document).delegate(lithium.formInputClickSelector, 'click.lithium', function(event) {
    var button = $(this);
  ...
  $(document).delegate(lithium.formSubmitSelector, 'ajax:beforeSend.lithium', function(event) {
    if (this == event.target) lithium.disableFormElements($(this));
  });

  $(document).delegate(lithium.formSubmitSelector, 'ajax:complete.lithium', function(event) {
