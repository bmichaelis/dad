...
class GravatarTest extends \lithium\test\Unit {
	...
	public function testUrlWithoutOptions() {
		...
		$expected = 'http://gravatar.com/avatar/978a05c7e2e60f547991b0ee47876553?d=404&s=80&r=g';
	...
	public function testUrlWithSize() {
		$expected = 'http://gravatar.com/avatar/08aff750c4586c34375a0ebd987c1a7e?d=404&s=40&r=g';
	...
	public function testUrlWithRating() {
		$expected = 'http://gravatar.com/avatar/08aff750c4586c34375a0ebd987c1a7e?d=404&s=80&r=x';
		$result = $this->helper->url('john@example.org', array('rating' => 'x'));
		$this->assertEqual($expected, $result);

		$expected = 'http://gravatar.com/avatar/08aff750c4586c34375a0ebd987c1a7e?d=404&s=80&r=pg';
